...
public class PdfGenerationService {
    ...
    public void createPdf(Optional<Client> client, File dest, Optional<Devis> devis, Optional<Contact> contact, Optional<Banque> banque, Basket basket, Optional<UserPermit> userPermit) throws IOException {
